...
public class XJavaFileManager extends ForwardingJavaFileManager<JavaFileManager> {

    private final XClassLoader classLoader;
    private final Map<URI, JavaFileObject> javaFileObjectMap = new ConcurrentHashMap<>();

    public XJavaFileManager(JavaFileManager fileManager, XClassLoader classLoader) {
        super(fileManager);
    ...
    public JavaFileObject getJavaFileForOutput(Location location, String className, JavaFileObject.Kind kind, FileObject sibling) throws IOException {
        JavaFileObject javaFileObject = new XJavaFileObject(className, kind);
